...
def post_save(model, os_path, contents_manager):
    """post-save hook for doing a git commit and push"""
    if model['type'] != 'notebook':
        return  # only do this for notebooks
    workdir, filename = os.path.split(os_path)
    os.chdir(workdir)
    os.system('git add {}'.formatfilename))
    os.system('git commit -m "Saved from JupyterLab"')
...
#  Default: '/Users/mufeng/.jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/Users/mufeng/.jupyter/lab/user-settings'
...
#  Default: '/Users/mufeng/.jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/Users/mufeng/.jupyter/lab/workspaces'
